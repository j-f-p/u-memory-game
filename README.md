...
### Abstract
This a browser game project for Section 3 of the Udacity Front-End Web Development Nanodegree. It is a fixed-view single-player game involving a rectangular grid of cards. 
